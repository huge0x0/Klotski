...
public class CreateLevel {
	...
	public CreateLevelView getView(){
		...
		mCreateLevelView.getButtonFinish().addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				LevelModel levelModel=LevelModel.getModel();
				PieceInformation[] pieceInformations=mCheckerBoard.getInformations();
				levelModel.setPieceInfos(pieceInformations);
				
				CreateLevel.getController().createFinish();
